...
function Footer() {
    return (
        <div className='d-flex flex-column align-items-center justify-content-center bg-dark' style={{ width: '100%', height: '300px' }}>
            <div className="footer d-flex  justify-content-evenly w-100">
                <div style={{ width: '400px' }} className="website">
                    <h4>
                        <i className="fa-brands fa-r-project" style={{color:'white'}}></i>
                        <span style={{ color: '#E75480' }}>Project Fair</span>
                    </h4 >
                    <h6 style={{color:'white'}}>Designed and built with all the love in the world by the Project Fair team with the help of our contributors</h6>
